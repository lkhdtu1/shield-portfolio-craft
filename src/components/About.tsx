          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white dark:bg-gray-900/50 p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-green-400 transition-all duration-300 hover:scale-105 shadow-sm"
                >
