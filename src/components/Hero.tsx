...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Background Grid */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-black dark:from-gray-900 dark:via-gray-800 dark:to-black light:from-gray-100 light:via-gray-200 light:to-gray-300">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8">
          ...
          <div className="text-xl md:text-2xl text-gray-300 dark:text-gray-300 light:text-gray-700 font-mono">
            <span className="text-green-400">$</span> {text}
            {isTyping && <span className="animate-pulse text-green-400">_</span>}
          </div>
        </div>
        
        <p className="text-lg md:text-xl text-gray-400 dark:text-gray-400 light:text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
